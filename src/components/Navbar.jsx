...
const Navbar = () => {
  ...
  return (
    <div className=' navbar w-full flex py-5 justify-between items-center  '>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center w-full text-white  overflow-hidden z-[101]  ">
